...
class ArlSimpleLidarNavigationSceneCfg(InteractiveSceneCfg):
    ...
    ray_caster_cfg = MultiMeshRayCasterCfg(
        ...
        update_period=1 / 60,
        offset=MultiMeshRayCasterCfg.OffsetCfg(pos=(0, 0, 0.5), rot=(0.0, 0.0, 0.0, 1.0)),
        mesh_prim_paths=[
            MultiMeshRayCasterCfg.RaycastTargetCfg(prim_expr="{ENV_REGEX_NS}/rod"),
        ],
        ray_alignment="yaw",
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        lidar_sector_min_distances = ObsTerm(
...
@configclass
class SimpleLidarNavigationEnvCfg(ManagerBasedRLEnvCfg):
